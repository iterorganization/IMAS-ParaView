...
def prepare_blueprints(tree: ET):
    ...
    for struct_ref in structure_references:
        ...
        nodes = tree.getroot().findall(f".//field/..[@structure_reference='{struct_ref}']")
...
if __name__ == '__main__':
    ...
    if len(sys.argv) >= 2:
        ...
        generate(os.path.join(base_dir, 'plugins/templates'), os.path.join(base_dir, 'plugins'))
